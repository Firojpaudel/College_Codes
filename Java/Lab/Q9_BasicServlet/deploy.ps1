...
javac -cp "../../lib/javax.servlet-api-4.0.1.jar" -d . BasicServlet.java
...
$appDir = Join-Path $TomcatPath "webapps\basic-app"
...
Copy-Item "BasicServlet.class" -Destination $classesDir -Force
...
# Open browser
Write-Output "Opening browser at http://localhost:8080/basic-app/basic"
Start-Process "http://localhost:8080/basic-app/basic"
