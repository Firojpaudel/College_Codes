...
$appDir = Join-Path $TomcatPath "webapps\student-jsp-app"
...
Copy-Item "register.jsp" -Destination $appDir -Force
...
# Open browser
Write-Output "Opening browser at http://localhost:8080/student-jsp-app/"
Start-Process "http://localhost:8080/student-jsp-app/"
