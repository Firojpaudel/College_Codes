...
javac -cp "../../lib/javax.servlet-api-4.0.1.jar" -d . LoginServlet.java
...
$appDir = Join-Path $TomcatPath "webapps\login-app"
...
Copy-Item "LoginServlet.class" -Destination $classesDir -Force
...
# Open browser
Write-Output "Opening browser at http://localhost:8080/login-app/"
Start-Process "http://localhost:8080/login-app/"
