...
javac -cp "../../lib/javax.servlet-api-4.0.1.jar" -d . RegisterServlet.java
...
$appDir = Join-Path $TomcatPath "webapps\register-app"
...
Copy-Item "register.html" -Destination $appDir -Force
Copy-Item "RegisterServlet.class" -Destination $classesDir -Force
...
# Open browser
Write-Output "Opening browser at http://localhost:8080/register-app/"
Start-Process "http://localhost:8080/register-app/"
