...
javac -cp "../../lib/javax.servlet-api-4.0.1.jar" -d . HelloServlet.java
...
$appDir = Join-Path $TomcatPath "webapps\hello-app"
...
Copy-Item "HelloServlet.class" -Destination $classesDir -Force
...
# Open browser
Write-Output "Opening browser at http://localhost:8080/hello-app/hello?name=John"
Start-Process "http://localhost:8080/hello-app/hello?name=John"
